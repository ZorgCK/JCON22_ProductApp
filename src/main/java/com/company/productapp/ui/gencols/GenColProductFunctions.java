...
package com.company.productapp.ui.gencols;

import com.company.productapp.dal.DAOProduct;
import com.company.productapp.domain.Product;
import com.company.productapp.ui.ViewPopupProduct;
import com.company.productapp.ui.ViewMain;
...
public class GenColProductFunctions extends HorizontalLayout implements RenderedComponent<Product>
{
	...
	{
		final ViewMain parent = UIUtils.getNextParent(this, ViewMain.class);
	...
	{
		DAOProduct.delete(this.value);
		UIUtils.getNextParent(this, ViewMain.class).refreshGrid();
	}
