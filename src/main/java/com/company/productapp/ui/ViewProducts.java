...
public class ViewProducts extends VerticalLayout
{
	...
	{
		this.grid.setItems(DAOProduct.findAll());
	}
	...
	private void initUI()
	{
		...
		this.grid.addColumn(Product::getUnitWeight).setKey("unitWeight").setHeader("Unit Weight (kg)")
			.setSortable(true);
		...
		this.filterComponent.setFilterSubject(GridFilterSubjectFactory.CreateFilterSubject(this.grid,
			Arrays.asList("category.categoryName", "category.categoryUuid", "description", "productName",
				"productUuid"),
